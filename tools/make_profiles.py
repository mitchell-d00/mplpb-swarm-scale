...
SOURCE = REPO / "docs" / "MPLPB_Deployment_Profiles.md"
STEM = "MPLPB_Deployment_Profiles"
...
SUBTITLE = "Four Places an MPLPB Corpus Gets Deployed, and What Changes Between Them"
...
def page_furniture(canvas, doc) -> None:
    ...
    if doc.page > 1:
        ...
        canvas.drawRightString(
            letter[0] - inch, letter[1] - 0.62 * inch, "MPLPB-DEPLOY-015 v1"
        )
...
def main() -> int:
    ...
    doc = BaseDocTemplate(
        ...
        subject="MPLPB-DEPLOY-015 v1 - deployment profiles",
    )
    frame = Frame(
