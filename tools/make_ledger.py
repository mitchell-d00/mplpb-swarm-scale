...
SOURCE = REPO / "docs" / "MPLPB_Ablation_Partial.md"
STEM = "MPLPB_Ablation_Partial"
...
TITLE = "A Partial Ablation"
SUBTITLE = "Two Runs, One Broken Instrument, and What the Second One Measured"
...
def page_furniture(canvas, doc) -> None:
    ...
    if doc.page > 1:
        ...
        canvas.drawRightString(
            letter[0] - inch, letter[1] - 0.62 * inch, "MPLPB-TEST-014 v2"
        )
...
def main() -> int:
    ...
    doc = BaseDocTemplate(
        ...
        subject="MPLPB-TEST-014 v2 - partial ablation trial ledger",
    )
    frame = Frame(
